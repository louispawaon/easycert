...
export function parseRecordCsv(rawText: string): ParseCsvResult {
...
/** Builds newline-separated preview from first column (for mirror `recordListText`). */
export function mirrorLinesFromFirstColumn(table: RecordTable): string {
